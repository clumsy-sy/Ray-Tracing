...
auto total_texture(hittable_list &world, hittable_list &light) -> void {
  ...
  world.add(std::make_unique<sphere>(point3(260, 150, 45), 50, std::make_shared<dielectric>(1.5)));
  world.add(std::make_unique<sphere>(point3(0, 150, 145), 50, std::make_shared<metal>(color(0.8, 0.8, 0.9), 1.0)));

  world.add(std::make_unique<sphere>(point3(360, 150, 145), 70, std::make_shared<dielectric>(1.5)));
  world.add(std::make_unique<constant_medium>(
      std::make_unique<sphere>(point3(360, 150, 145), 70, std::make_shared<dielectric>(1.5)), 0.2,
      color(0.2, 0.4, 0.9)));
  world.add(std::make_unique<constant_medium>(
      std::make_unique<sphere>(point3(0, 0, 0), 5000, std::make_shared<dielectric>(1.5)), .0001, color(1, 1, 1)));

  auto emat = std::make_shared<lambertian>(std::make_shared<image_texture>("src/models/earth/earthmap.jpg"));
  world.add(std::make_unique<sphere>(point3(400, 200, 400), 100, emat));
  auto pertext = std::make_shared<noise_texture>(0.1);
  world.add(std::make_unique<sphere>(point3(220, 280, 300), 80, std::make_shared<lambertian>(pertext)));
