...
public:
  ...
  -> lookat[x: %5.3lf  y: %5.3lf  z: %5.3lf] vup[x: %5.3lf  y: %5.3lf  z: %5.3lf]\n",
        lookfrom[0], lookfrom[1], lookfrom[2], lookat[0], lookat[1], lookat[2], vup[0], vup[1], vup[2]);
  ...
  vertical[x: %5.3lf  y: %5.3lf  z: %5.3lf], lower_left_corner[x: %5.3lf  y: %5.3lf  z: %5.3lf]\n",
        horizontal[0], horizontal[1], horizontal[2], vertical[0], vertical[1], vertical[2], lower_left_corner[0],
        lower_left_corner[1], lower_left_corner[2]);
    printf("          | vfov: %5.3lf, theta: %5.3lf,h: %5.3lf, viewport_height: %5.3lf, viewport_width: % 5.3f\n", vfov,
        theta, h, viewport_height, viewport_width);
    printf("----------------------------------------\n");
#endif
  }
